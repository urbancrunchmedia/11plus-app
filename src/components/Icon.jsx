...
const ICONS = {
  ...
  // Sound-effects mute toggle — a real speaker, not a bell (a bell reads as
  // "notifications", which this isn't).
  ...
  // "Hear this word said aloud" (FlashcardScreen) — a speech bubble, kept
  // visually distinct from volumeOn/Off so the two sound-related actions
  // (mute vs. pronounce) don't look like the same button.
  speak:    '<path d="M4 5h13a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2h-6l-4 3v-3H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2z"/><path d="M7.5 10h8"/>',
